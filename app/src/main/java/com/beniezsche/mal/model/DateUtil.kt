...
object DateUtil {
    ...
    val monthNameList = arrayOf("January","February","March","April","May","June","July","August","September","October","November","December")
    val monthDaysList = arrayOf(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31)

//    private val daysList = ArrayList<Day>()

    private const val NO_OF_MONTHS = 12

    const val CURRENT_DEBUG = "size"
    ...
    private fun getStartingDayOfTheWeekOfAMonth(month: Int, year: Int): Int {
     ...
     fun getDaysFromMonth(month: Int, year: Int, totalDays: Int) : ArrayList<Int> {
        ...
        val startPos = getStartingDayOfTheWeekOfAMonth(month, year)
